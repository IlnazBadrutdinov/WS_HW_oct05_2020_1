 ...
 * 
 */
@WebServiceClient(name = "HelloWorldService", targetNamespace = "http://ws.mkyong.com/", wsdlLocation = "http://localhost:8887/ilnaz2?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8887/ilnaz2?wsdl");
